...
<div class="container img_sup">
	<div class="row">
	  <div class="col-md-4 home"><img src="<?php bloginfo('template_url'); ?>/img_movil/home.png" class="img-responsive" alt="Placeholder image"></div>
	</div>
</div>
	
<div class="container text_sup">
		<a id="region4" name="region" class="margen_region"></a>
  <div class="row">
    <div class="col-md-4 interactivo">
	    <span class="label label-interactivo">INTERACTIVO</span> 
	</div>
    <div class="col-md-4 hallazgos">
	    <span class="label label-hallazgos">Memoriales</span> 
	</div>
  </div>
</div>